  ...
  return (
    <Card className="w-full h-full md:w-110 border-none shadow-none">
      <CardHeader className="pl-10">
        ...
        <CardDescription>
          {/* TODO: add privacy policy page and terms of service page */}
      ...
      <CardContent className="px-10 space-y-7">
        <form
          id="form-sign-up"
          className=""
        ...
        <Field orientation="horizontal">
          ...
          <Button type="submit" disabled={isPending} form="form-sign-up">
            Submit
          </Button>
        </Field>
      </CardContent>
      ...
      <CardContent className="px-10 flex items-center justify-center">
